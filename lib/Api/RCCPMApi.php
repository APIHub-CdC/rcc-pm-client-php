...
use RCCPM\MX\Client\ApiException;
use RCCPM\MX\Client\Configuration;
use RCCPM\MX\Client\HeaderSelector;
...
class RCCPMApi
{
    ...
    {
        $returnType = '\RCCPM\MX\Client\Model\ReporteRespuesta';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RCCPM\MX\Client\Model\ReporteRespuesta',
